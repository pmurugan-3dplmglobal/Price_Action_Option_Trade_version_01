...
PROGRAMS = {
    "index": {
        ...
        "config_fields": {
            "timeframe": {"label": "Timeframe", "type": "select", "options": ["minute","3minute","5minute","10minute","15minute","30minute","60minute"], "default": "3minute"},
    ...
    "nifty50": {
        ...
        "config_fields": {
            "timeframe": {"label": "Timeframe", "type": "select", "options": ["5minute","10minute","15minute","30minute","60minute"], "default": "15minute"},
            "lookback_days": {"label": "Lookback Days", "type": "number", "default": 30},
